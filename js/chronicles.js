  ...
  /* ARTICLE 2: The Flight Response */
  {
    ...
    pages: [
      ...
      { type: 'text', section: 'Safety in Numbers', html: `
        ...
        <p>This is why isolation is one of the most psychologically damaging things that can be done to a horse. Stabled horses kept without visual or physical contact with other horses show measurable increases in stress hormones, stereotypic behaviors like weaving, crib biting, box walking, and heightened reactivity. They are not being difficult. They are expressing the profound biological distress of an animal whose survival system is telling it that it is in danger.</p>
  ...
  /* ARTICLE 4: Reading Body Language */
  {
    ...
    pages: [
      ...
      { type: 'text', section: 'The Ears', html: `
        ...
        <p>Ears soft and relaxed to the side, sometimes called lopeared, means a deeply calm horse. This is the position of true rest, of a horse that has let its guard down completely. If a horse you are working with drops into this position, stop what you are doing and let it stand. You have reached a place of real relaxation. Preserve it.</p>
